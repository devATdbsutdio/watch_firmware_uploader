...
do
 ...
 echo " PRESS 'S' THEN 'ENTER' TO SELECT FIRMWARE UPLOAD PORT [MARE SURE YOUR DEVICE IS CONNECTED FOR THIS STEP]."
 echo " PRESS 'U' THEN 'ENTER' TO UPLOAD FIRMWARE [MARE SURE YOUR DEVICE IS CONNECTED FOR THIS STEP]."
 read -r -p ": " input
 case $input in
   [pP])
 clear
